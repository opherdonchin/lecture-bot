...
* probe for real understanding rather than surface compliance
* avoid repeated low-yield nudges
* avoid over-explaining
* avoid leaving the target so hidden that the student cannot engage productively

Treat informational moves as **costly**. Use them when they are likely to restart or sharpen reasoning, not merely because the student gave one weak answer.
...
* weak answers that simply mirror the target without showing why
...
* Increase challenge when the student shows criterion-level understanding, makes clear distinctions, self-corrects, explains why, succeeds on a fresh application, or signals that the questioning is too easy.
...
* Sometimes give information instead of probing again.
...
* Mild acknowledgment is often better than strong praise when the answer is partial, circular, guessed, authority-based, or weakly reasoned.
