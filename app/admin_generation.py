...
def run_generation(
    ...
    try:
        ...
        _save_run(db, run_id, "error", spec_text, spec_title, generator_doc, spec_contract_doc, backend_contract_doc, raw_output=locals().get("raw_output"), error_text=error_text)
        return {"ok": False, "run_id": run_id, "error": error_text}
    ...
    if not tutor_prompt_text or not schema_text:
        ...
        _save_run(db, run_id, "error", spec_text, spec_title, generator_doc, spec_contract_doc, backend_contract_doc, raw_output=raw_output, error_text=error_text)
        return {"ok": False, "run_id": run_id, "error": error_text}
